...
let fakemonPaths = [
  ...
  "./assets/images/fakemon/14.jpeg",
  "./assets/images/fakemon/15.jpeg",
...
document.getElementById("choice1").src = fakemonPaths[0];
document.getElementById("choice2").src = fakemonPaths[18];
document.getElementById("choice3").src = fakemonPaths[23];

document.getElementById("choice4").src = fakemonPaths[20];
document.getElementById("choice5").src = fakemonPaths[9];

document.getElementById("choice1").width = "300";
document.getElementById("choice1").height = "500";

document.getElementById("choice2").width = "300";
document.getElementById("choice2").height = "500";

document.getElementById("choice3").width = "300";
document.getElementById("choice3").height = "500";

document.getElementById("choice4").width = "300";
document.getElementById("choice4").height = "500";

document.getElementById("choice5").width = "300";
document.getElementById("choice5").height = "500";
